...
import org.andy.lambda.entity.Student;
import org.andy.lambda.entity.User;
...
//        Files.newDirectoryStream(Paths.get("D:" + File.separator + "java")).forEach(System.out::println);
