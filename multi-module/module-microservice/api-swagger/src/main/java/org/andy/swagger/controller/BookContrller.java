...
import org.andy.swagger.service.BookService;
...
//        return book;
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "book", value = "图书实体book", required = true, dataType = "Book", paramType = "body")
    })
...
//    public PageDto<ElectronicFenceWarningVo> warningPage(@RequestParam @NotBlank String vin, Pageable pageable) throws BusinessException {
//        Long currentUid = GatewayUtilWrapper.getAuthSessionUid();
//        return electronicFenceWarningService.warningList(currentUid, vin, pageable);
//    }
}