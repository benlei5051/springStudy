...
public final class RegexpUtils
{
    ...
    /**
     * 匹配整数位最大14位且小数位最大2位的数
     */
    public static final String GOODS_PRICE_REGEXP = "^(\\d{0,14})(\\.\\d{1,2})?$";
    /**
     * 匹配整数位最大7位且小数位最大2位的数
     */
    public static final String PRICE_REGEXP = "^(\\d{0,7})(\\.\\d{1,2})?$";
    /**
     * 匹配不包括零的非负整数（正整数 > 0)
     */
     ...
     * 匹配(0或8位正整数或8位负整数)
     */
    public static final String POSITIVE_NEGATIVE_INTEGERS_EIGHT = "^(0|[0-9]{1,8}|-[0-9]{1,8})$";
    ...
    public static boolean test(String date)
    {
        ...
        Pattern pat = Pattern.compile(NON_ZERO_NEGATIVE_INTEGERS_REGEXP);
