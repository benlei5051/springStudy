...
public class DateUtil {
     ...
     */
    public static final long DAYMILLI = 24 * 60 * 60 * 1000L;
    /**
     * the milli seconds of an hour
     */
    public static final long HOURMILLI = 60 * 60 * 1000L;
    /**
     * the milli seconds of a minute
     */
    public static final long MINUTEMILLI = 60 * 1000L;
    /**
    ...
    public static Date addSecond(Date date, int sec) {
        ...
        cal.setTime(date);
        long datevalue = (cal.getTimeInMillis() + (1000*sec));
